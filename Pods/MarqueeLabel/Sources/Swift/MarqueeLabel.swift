...
open class MarqueeLabel: UILabel, CAAnimationDelegate {
    ...
    */
    ...
    private func timingFunctionForAnimationCurve(_ curve: UIView.AnimationCurve) -> CAMediaTimingFunction {
        ...
        switch curve {
        case .easeIn:
            timingFunctionName = CAMediaTimingFunctionName.easeIn.rawValue
        case .easeInOut:
            timingFunctionName = CAMediaTimingFunctionName.easeInEaseOut.rawValue
        case .easeOut:
            timingFunctionName = CAMediaTimingFunctionName.easeOut.rawValue
        default:
            timingFunctionName = CAMediaTimingFunctionName.linear.rawValue
        }
        
        return CAMediaTimingFunction(name: CAMediaTimingFunctionName(rawValue: timingFunctionName!))
    }
